...
class ICustomCollectionView:  UICollectionView {
...
extension ICustomCollectionView: UICollectionViewDataSource {
...
extension ICustomCollectionView: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView,
...
class ICustomCollectionViewCell: UICollectionViewCell {
    static let identifier = "CollectionViewCell3"
